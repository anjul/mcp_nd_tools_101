...
Discovery is the phase where the AI Client (e.g., Claude Desktop, Cursor) connects to the MCP Server and learns what it can do. It functions exactly like **REST API Swagger Documentation (`/openapi.json`)**.
